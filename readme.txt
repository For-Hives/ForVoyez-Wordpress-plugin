...
1. Upload the plugin files to the `/wp-content/plugins/auto-alt-text-for-images` directory, or install the plugin through the WordPress plugins screen directly.
...
= 1.1.29 =
Just after a really kind message from a super user, we tried to improve the plugin by adding some quality of life features.
...
Also, we have added a new feature that allows you to see the remaining credits in the settings page.
And in the manage media page.
...
= 1.1.23 =
Fixes some bugs, issues, improve capabilities and performance.
