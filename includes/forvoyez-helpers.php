 ...
 *
 * @since 1.0.0
 * @return array Token information or error data.
 */
function forvoyez_get_token_info() {
	global $forvoyez_settings;
	...
	$api_client = new Forvoyez_API_Manager($api_key, '', '');
	$token_info = $api_client->get_token_info();
