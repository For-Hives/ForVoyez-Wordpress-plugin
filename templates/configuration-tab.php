        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
            ...
            <div class="mb-4">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                    <input type="password" name="forvoyez_api_key" id="forvoyez-api-key" class="forvoyez-api-key-input flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-l-md focus:ring-blue-500 focus:border-blue-500 sm:text-sm border-gray-300" placeholder="<?php esc_attresc_html_e('Enter your API key', 'forvoyez-auto-alt-text-for-images'); ?>" value="<?php echo esc_attr($api_key); ?>">
                    <button type="button" class="forvoyez-toggle-visibility inline-flex items-center px-3 rounded-r-md border border-l-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm" aria-label="<?php esc_attresc_html_e('Toggle API key visibility', 'forvoyez-auto-alt-text-for-images'); ?>">
