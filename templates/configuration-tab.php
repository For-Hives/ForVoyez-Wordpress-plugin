...
<div class="configuration-tab">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6">
            <h2 class="text-lg leading-6 font-medium text-gray-900"><?php esc_html_e('API Configuration', 'forvoyez-auto-alt-text-for-images'); ?></h2>
            <p class="mt-1 max-w-2xl text-sm text-gray-500"><?php esc_html_e('Manage your ForVoyez API settings here', 'forvoyez-auto-alt-text-for-images'); ?></p>
        </div>
        <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
            <div class="mb-6">
                <h3 class="text-md font-medium text-gray-900 mb-2"><?php esc_html_e('About ForVoyez API', 'forvoyez-auto-alt-text-for-images'); ?></h3>
                <p class="text-sm text-gray-600 mb-2">
                    <?php esc_html_e('ForVoyez API provides powerful image analysis capabilities for your WordPress site. To use this plugin, you need to obtain an API key from ForVoyez.', 'forvoyez-auto-alt-text-for-images'); ?>
                </p>
                <p class="text-sm text-gray-600 mb-2">
            ...
            <div class="mb-4">
                <label for="forvoyez-api-key" class="block text-sm font-medium text-gray-700"><?php esc_html_e('API Key', 'forvoyez-auto-alt-text-for-images'); ?></label>
                <div class="mt-1 flex rounded-md shadow-sm">
                    <input type="password" name="forvoyez_api_key" id="forvoyez-api-key"
                           class="forvoyez-api-key-input flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-l-md focus:ring-blue-500 focus:border-blue-500 sm:text-sm border-gray-300"
                           placeholder="<?php esc_attr_e('Enter your API key', 'forvoyez-auto-alt-text-for-images'); ?>" value="<?php echo esc_attr($api_key); ?>">
                    <button type="button"
                            ...
                            aria-label="<?php esc_attr_e('Toggle API key visibility', 'forvoyez-auto-alt-text-for-images'); ?>">
            ...
            <div class="mt-4">
                <button type="button"
                    ...
                    <?php esc_html_e('Save API Key', 'forvoyez-auto-alt-text-for-images'); ?>
                </button>
            </div>
            <div class="mt-4 p-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700">
                <p>
                    <?php esc_html_e('This plugin uses the ForVoyez API service to generate alt text and metadata for images. By using this plugin, you agree to the ForVoyez Terms of Service and Privacy Policy.', 'forvoyez-auto-alt-text-for-images'); ?>
                </p>
                <p class="mt-2">
                    <?php
                    printf(
                        ...
                        /* translators: %1$s: URL to Terms of Service, %2$s: URL to Privacy Policy, %3$s: URL to Legal Notice */
                            __('Please review the <a href="%1$s" target="_blank" rel="noopener noreferrer" class="underline">Terms of Service</a>, <a href="%2$s" target="_blank" rel="noopener noreferrer" class="underline">Privacy Policy</a>, and <a href="%3$s" target="_blank" rel="noopener noreferrer" class="underline">Legal Notice</a>.', 'forvoyez-auto-alt-text-for-images'),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'target' => array(),
