<div class="wrap p-6 min-h-screen relative [&_button,a]:shadow-none [&_button,a]:outline-none">
    <h1 class="text-3xl font-bold mb-6 text-gray-800"><?php _e('Auto Alt Text for Images', 'forvoyez-auto-alt-text-for-images'); ?></h1>
	<div class="py-4 w-full flex justify-between items-start">
		<div class="flex flex-col gap-2 items-center">
            <h3 class="text-start w-full font-bold">
                <?php _e('Legend :', 'forvoyez-auto-alt-text-for-images'); ?>
            </h3>
			<div class="flex gap-6 items-center">
				<div class="flex items-center gap-2">
                    <p class="text-gray-700 italic">
                        <?php _e('Missing Alt Text :', 'forvoyez-auto-alt-text-for-images'); ?>
                    </p>
				...
				<div class="flex items-center gap-2">
                    <p class="text-gray-700 italic">
                        <?php _e('Missing title :', 'forvoyez-auto-alt-text-for-images'); ?>
                    </p>
				...
				<div class="flex items-center gap-2">
                    <p class="text-gray-700 italic">
                        <?php _e('Missing caption :', 'forvoyez-auto-alt-text-for-images'); ?>
                    </p>
				...
				<div class="flex items-center gap-2">
                    <p class="text-gray-700 italic">
                        <?php _e('All complete :', 'forvoyez-auto-alt-text-for-images'); ?>
                    </p>
			...
			<div class="flex flex-wrap items-center justify-between gap-4">
				<div class="flex items-center space-x-4">
					<label class="flex items-center">
                        <span class="mr-2 text-sm font-medium text-gray-700"><?php _e('Items per page:', 'forvoyez-auto-alt-text-for-images'); ?></span>
						<select id="forvoyez-per-page" name="per_page"
                            ...
                            <option value="-1"><?php _e('All', 'forvoyez-auto-alt-text-for-images'); ?></option>
						</select>
					</label>
				</div>
				<div>
                    <button type="button" id="forvoyez-analyze-missing" class="bg-gray-700 hover:bg-gray-900 cursor-not-allowed text-white font-bold py-2 px-4 rounded" disabled>
                        <?php _e('Analyze all missing alt/caption/title images', 'forvoyez-auto-alt-text-for-images'); ?> (<span id="forvoyez-missing-count">0</span>)
                    </button>
                    <button type="button" id="forvoyez-analyze-missing-alt" class="bg-gray-700 hover:bg-gray-900 cursor-not-allowed text-white font-bold py-2 px-4 rounded" disabled>
                        <?php _e('Analyze all missing alt images', 'forvoyez-auto-alt-text-for-images'); ?> (<span id="forvoyez-missing-alt-count">0</span>)
                    </button>
                    <button type="button" id="forvoyez-analyze-all" class="bg-gray-700 hover:bg-gray-900 cursor-not-allowed text-white font-bold py-2 px-4 rounded" disabled>
                        <?php _e('Analyze all images', 'forvoyez-auto-alt-text-for-images'); ?> (<span id="forvoyez-all-count">0</span>)
                    </button>
				</div>
			</div>
		</form>
		...
		<div class="forvoyez-bulk-actions mt-4 flex gap-4 items-center w-full justify-between">
			<div>
				<label class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-gray-700"><?php _e('Select All', 'forvoyez-auto-alt-text-for-images'); ?></span>
				</label>
                <button id="forvoyez-bulk-analyze" class="bg-forvoyez-secondary hover:bg-forvoyez-secondary-dark text-white font-bold py-2 px-4 rounded ml-4">
                    <?php _e('Analyze Selected Images', 'forvoyez-auto-alt-text-for-images'); ?>
                </button>
			</div>
	...
	<div id="forvoyez-confirm-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full" style="z-index: 1000;">
		<div class="relative top-1/2 -translate-y-1/2 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <h2 class="text-2xl font-bold mb-4 text-gray-800"><?php _e('Confirm Analysis', 'forvoyez-auto-alt-text-for-images'); ?></h2>
