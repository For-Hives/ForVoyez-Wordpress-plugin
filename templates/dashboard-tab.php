<div class="dashboard-tab">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Quick Start Guide</h3>
            <p class="mt-1 max-w-2xl text-sm text-gray-500">Follow these steps to get started with Auto Alt Text for Images</p>
        </div>
