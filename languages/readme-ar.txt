...
1. قم بتحميل ملفات الإضافة إلى الدليل `/wp-content/plugins/auto-alt-text-for-images`، أو قم بتثبيت الإضافة مباشرة من خلال شاشة الإضافات في ووردبريس.
...
يعتمد هذا البرنامج المساعد على خدمة ForVoyez API لإنشاء نص بديل وبيانات وصفية للصور. عند استخدام هذا البرنامج المساعد، يتم إرسال بيانات الصورة إلى خوادم ForVoyez للمعالجة.

خدمة ForVoyez API: https://forvoyez.com

باستخدام هذا البرنامج المساعد، فإنك توافق على المستندات القانونية التالية لـ ForVoyez:
...
يرجى مراجعة هذه المستندات لفهم كيفية التعامل مع بياناتك عند استخدام هذا البرنامج المساعد. من المهم أن تكون على دراية بهذه الشروط حيث أنها تحكم استخدام خدمة ForVoyez التي تعد جزءًا لا يتجزأ من وظائف هذا البرنامج المساعد.

تقوم ForVoyez بمعالجة الصور التي تقدمها من خلال هذا البرنامج المساعد لإنشاء نص بديل وبيانات وصفية أخرى. تتم هذه المعالجة على خوادم ForVoyez وتخضع لممارسات التعامل مع البيانات الخاصة بهم كما هو موضح في سياسة الخصوصية الخاصة بهم.
