...
;(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Remplacez la section du toggle auto-analyze par ce code :
        $('#forvoyez-auto-analyze').on('change', function () {
            ...
            if (isEnabled) {
                $('#forvoyez-auto-analyze-body').removeClass('bg-gray-300').addClass('bg-green-400');
                $('#forvoyez-auto-analyze-dot').removeClass('-left-1').addClass('-right-1');
            } else {
                $('#forvoyez-auto-analyze-body').removeClass('bg-green-400').addClass('bg-gray-300');
                $('#forvoyez-auto-analyze-dot').removeClass('-right-1').addClass('-left-1');
            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        showNotification('Auto-analyze setting updated successfully', 'success');
                    } else {
                        ...
                        showNotification('Failed to update auto-analyze setting', 'error');
                    }
                },
                error: function () {
                    // Revert the toggle state
                    ...
                    showNotification('Error occurred while updating setting', 'error');
                },
                complete: function () {
