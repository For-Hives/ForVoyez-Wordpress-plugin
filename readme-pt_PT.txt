...
1. Carregue os ficheiros do plugin para o diretório `/wp-content/plugins/auto-alt-text-for-images`, ou instale o plugin diretamente através do ecrã de plugins do WordPress.
